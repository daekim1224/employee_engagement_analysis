...
This document shows my R codes that I used to prepare and analyze Hooli's employee survey data. Please use the table of content on the left side of this document to navigate the document. If you click "Show" button in each section, you can see my code. The document is structured as follows: <br>
