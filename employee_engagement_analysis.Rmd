...
tenure_groups <- cut(tenure_months,
                      ...
                      labels = c("Under 3 months", "3-6 months", "1-2 years", "1-2 years", "2-4 years", "4-6 years", "6-10 years", "10+ years"), right = FALSE) # right = FALSE to EXCLUDE the right side month in the cateogry
...
```
  ...
  * 3. Calculate favorable scores for all questions and factors by gender
    - a. favorable scores for all questions for women
        - N for female = 820
```{r}
table(df_2$gender)
...
```
 ...
 - e. favorable scores for all questions for women for Under 3 months
      N = 25
```{r}
df_2[
  df_2$gender == "Female" & 
...
ggplot(engagement_favorable_score_for_all, aes(x = question_number, y = favorability_score, fill = highlight)) +
  ...
  scale_fill_manual(values = highlight_colors)  
```
- f. favorable scores for all questions for women with tenure between 3-6 months 
      N = 116
```{r}
...
ggplot(engagement_favorable_score_for_all, aes(x = question_number, y = favorability_score, fill = highlight)) +
  ...
  scale_fill_manual(values = highlight_colors)  
```
 - g. favorable scores for all questions for women with tenure between 6-12 months 
      N = 181
```{r}
table(df_2$gender, df_2$tenure_group)
df_2[
...
ggplot(engagement_favorable_score_for_all, aes(x = question_number, y = favorability_score, fill = highlight)) +
  ...
  scale_fill_manual(values = highlight_colors)  
```
- h. favorable scores for all questions for women with tenure between 1-2 years 
      N = 211
```{r}
table(df_2$gender, df_2$tenure_group)
df_2[
...
- i. favorable scores for all questions for women with tenure between 2-4 years 
      N = 191
```{r}
table(df_2$gender, df_2$tenure_group)
df_2[
...
- j. favorable scores for all questions for women with tenure between 4-6 years 
      N = 58
```{r}
table(df_2$gender, df_2$tenure_group)
df_2[
...
- k. favorable scores for all questions for women with tenure between 4-6 years 
      N = 37
```{r}
table(df_2$gender, df_2$tenure_group)
df_2[
...
engagement_factor_correlation_table <- engagement_factor_correlation_table %>%
  arrange(correlation)  # Ascending order
...
# Create a ggplot with horizontal bars in ascending order
library(ggplot2)
ggplot(engagement_factor_correlation_table, aes(x = correlation, y = variable)) +
  geom_bar(stat = "identity", fill = "purple", alpha = 0.7) +  
  labs(x = "Correlation", y = "Variable", title = "Correlations with Engagement Factor") +
  theme_minimal() +
  theme(
    axis.text.y = element_text(size = 12),  
...
ggplot(engagement_factor_correlation_table, aes(x = correlation, y = variable)) +
  geom_bar(stat = "identity", fill = "purple", alpha = 0.7) +  
  labs(x = "Correlation", y = "Variable", title = "Correlations with Engagement Factor for Women") +
  theme_minimal() +
  theme(
    axis.text.y = element_text(size = 12),  
    axis.title = element_text(size = 14),  
...
ggplot(engagement_factor_correlation_table, aes(x = correlation, y = variable)) +
  geom_bar(stat = "identity", fill = "purple", alpha = 0.7) +  
  labs(x = "Correlation", y = "Variable", title = "Correlations with Engagement Factor for Men") +
  theme_minimal() +
  theme(
    axis.text.y = element_text(size = 12),  
    axis.title = element_text(size = 14),  
