...
```
  * 1. Calculate the favorable scores for all questions and factors for Hooli Overall.
    - a. Favorability scores for all questions below:
```{r}
...
#let's create a function to automatate the process of calculating favorability score for all questions:
...
```
      - b. Calculate a 'Factor Favorable Score', which is the average favorable score among questions within a factor.
```{r}
...
```
  * 2. Calculate engagement factor scores by all tenure groups. 
    - a. engagement factor scores for employees whose tenure are "Under 3 Months".
      n = 47
```{r}
...
```
    ...
    - b.engagement factor scores for employees whose tenure are "6-12 months".
      n = 290
```{r}
#6-12 months
...
```  
    ...
    - c. engagement factor scores for employees whose tenure are "1-2 years".
      N = 429
```{r}
#1-2 years
...
print(favorability_score)
```  
    - d. engagement factor scores for employees whose tenure are "2-4 years".
      n = 380
```{r}
#2-4 years
