...
print(favorability_score)
```
      - Calculate a 'Factor Favorable Score', which is the average favorable score among questions within a factor.
```{r}
#let's create a function that automates for this type of analysis in the future:
...
# Print the factor favorable scores
